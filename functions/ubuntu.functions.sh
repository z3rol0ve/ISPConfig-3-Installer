...
apt-get -y install php7.0 php7.0-mysqlnd php7.0-mcrypt mcrypt
...
apt-get install apache2 apache2-doc apache2-utils libapache2-mod-php7.0 php7.0 php7.0-fpm php7.0-common php7.0-gd php7.0-mysqlnd php7.0-imap phpmyadmin php7.0-cli php7.0-cgi libapache2-mod-fcgid apache2-suexec php-pear php-auth php7.0-mcrypt mcrypt php7.0-imagick imagemagick libapache2-mod-suphp libruby libapache2-mod-python php7.0-curl php7.0-intl php7.0-memcached php7.0-memcache php7.0-ps php7.0-pspell php7.0-recode php7.0-sqlite php7.0-tidy php7.0-xmlrpc php7.0-xsl memcached php7.0-fpm libapache2-mod-fastcgi
...
apt-get -y install php7.0 php7.0-fpm php7.0-common php7.0-curl php7.0-gd php7.0-mysqlnd php7.0-intl php-pear php7.0-imagick imagemagick php7.0-mcrypt mcrypt php7.0-imap php7.0-memcached php7.0-memcache memcached php7.0-ps php7.0-pspell php7.0-recode php7.0-sqlite php7.0-tidy php7.0-xmlrpc php7.0-xsl
apt-get install
...
apt-get -y install php7.0-geoip
